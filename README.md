...
A static site built using [Gatsby](https://www.gatsbyjs.com/).

Content is stored in markdown files in [recordings](./recordings) & the images are in [src/images](/src/images).
